...
Both at work and at home, I explore FOSS solutions and strive to create sustainable, independent environments.
...
I love exploring collaboration methods so even with one-man projects I create Github orgs to place my projects into.

- [Houby Studio](https://github.com/houby-studio)
- [Arcane Apps Alchemists Org](https://github.com/aaaorg)
- [Dotyker](https://github.com/dotyker)
...
- **Stack:** Quasar.js, Electron, PowerShell  
...
- [View repository](https://github.com/dotyker/dotyker)

---

## ⚙️ Philosophy

> **Automation first, vendor lock-in last.**  
> I believe in open, modular, and transparent IT environments where infrastructure is reproducible and manageable through code.
...
| Area | Description |
|------|--------------|
| 🔁 **Continuous Learning** | Regularly testing FOSS tools and integrating them into real workflows |
| 🧩 **Modularity** | Every service is containerized, reproducible, and version-controlled |
| 🔍 **Transparency** | Configuration as code, documentation as Markdown |
| 📦 **CI/CD Everywhere** | Even small experiments get automated build and deploy pipelines |
...
### [Sololearn](https://www.sololearn.com/en/profile/16923263)
